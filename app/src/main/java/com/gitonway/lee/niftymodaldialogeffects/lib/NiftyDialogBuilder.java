...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private void init(Context context) {
        ...
        mImg = (ImageView) mDialogView.findViewById(R.id.imgDialog);
    ...
    public NiftyDialogBuilder withImg(int drawableResId, boolean animado) {
        mImg.setBackgroundResource(drawableResId);
        if(animado) {
            AnimationDrawable frameAnimation = (AnimationDrawable) mImg.getBackground();
